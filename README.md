...
If you want to use more than one GPU, it is important to change the sampler in train.py and to change the StateDictType in fsdp&#95;&#95;init&#95;&#95;.py. Then the starting is don via
